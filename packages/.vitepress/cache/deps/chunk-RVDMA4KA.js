...
var BaseReactiveHandler = class {
  ...
  get(target, key, receiver) {
    ...
    if (key === '__v_isReactive') {
      ...
      if (
        receiver ===
          (isReadonly2 ? (isShallow2 ? shallowReadonlyMap : readonlyMap) : isShallow2 ? shallowReactiveMap : reactiveMap).get(target) || // receiver is not the reactive proxy, but has the same prototype
...
function trackRefValue(ref2) {
  ...
  if (shouldTrack && activeEffect) {
    ...
    trackEffect(
      activeEffect,
      (_a = ref2.dep) != null ? _a : (ref2.dep = createDep(() => (ref2.dep = void 0), ref2 instanceof ComputedRefImpl ? ref2 : void 0)),
      true
        ? {
            target: ref2,
            type: 'get',
...
vue/dist/vue.runtime.esm-bundler.js:
  ...
  **)
*/
//# sourceMappingURL=chunk-RVDMA4KA.js.map
